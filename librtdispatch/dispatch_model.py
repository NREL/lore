...
class RealTimeDispatchModel(object):
    ...
    def generateParams(self,params):
        ...
        self.model.Qin = pe.Param(self.model.T_inputs, mutable=True, initialize=params.Qin, units=units.USD/units.kW)    #Q^{in}_{t}: Available thermal power generated by the CSP heliostat field in period $t$ [kW\sst]
        ...
        self.model.Ccsb = pe.Param(mutable=True, initialize=params.Ccsb, units=units.USD/units.kWh)         #Ccsb: Operating cost of power cycle standby operation [\$/kWh\sst]
        if self.include["signal"]:
        ...
        self.model.Cp = pe.Param(mutable=True, within=pe.NonNegativeReals, initialize=params.Cp, units=units.kW)  # Tower piping heat trace part load parasitic loss [kW\sse]
